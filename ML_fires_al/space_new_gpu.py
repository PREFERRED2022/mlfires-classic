...
def create_space():
    ...
    testsets = {'balanced':'/mnt/nvme2tb/ffp/datasets/fires_new_norm.csv', 'imbalanced':'dataset_1_10_corine_level2_onehotenc.csv'}
    calc_train_metrics = True
    #opt_targets = ['hybrid2 val', 'hybrid5 val', 'f1-score 1 val.', 'auc val.', 'recall 1 val.']
    #opt_targets = ['auc val.']
    #opt_targets = ['NH2', 'NH5', 'hybrid2', 'hybrid5', 'NH10', 'auc', 'hybrid1']
    opt_targets = ['NH10']
    modeltype = 'tf'
    #modeltype = 'sk'
    description = 'NN_vl'
